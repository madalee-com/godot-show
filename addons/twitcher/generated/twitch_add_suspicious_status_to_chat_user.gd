...
class_name TwitchAddSuspiciousStatusToChatUser
	


## 
## #/components/schemas/AddSuspiciousStatusToChatUserBody
class Body extends TwitchData:
	...
	## The type of suspicious status. Possible values are: ACTIVE\_MONITORING, RESTRICTED
	...
	static func create(_user_id: String, _status: String) -> Body:
...
## 
## #/components/schemas/AddSuspiciousStatusToChatUserResponse
...
## An array with one object containing information about the suspicious user action.
## #/components/schemas/AddSuspiciousStatusToChatUserResponse/Data
